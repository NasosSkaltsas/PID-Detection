...
from scripts.functions.network_functions.create_network import create_delaunay_graph,draw_graph_on_image,save_edges_as_json
...
if __name__ == "__main__":
    ...
    save_edges_as_json(G, artifacts_path)
